...
class WallsRoomMovementShould extends RoomMovementTestBase {

    @Override
    protected String testFilesSubDir() {
        return "movement/walls";
    }

    @ParameterizedTest
    @MethodSource("test1Args")
    void move_bryn_thru_room_with_walls(String inputFile, String outputFile, String movesStr) throws Exception {
